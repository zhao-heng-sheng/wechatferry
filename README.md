...
>[!TIP]
> 再一次让 Wechaty 免费协议(PC Hook)重放荣光 - [@wechatferryxxx/puppet](https://wcferry.netlify.app/integrations/wechaty.html)
...
|名称|描述|
|---|---|
|[@wechatferryxxx/core](https://github.com/wechatferry/wechatferry/tree/main/packages/core)| 调用 sdk.dll 封装 tcp 连接 |
|[@wechatferryxxx/agent](https://github.com/wechatferry/wechatferry/tree/main/packages/agent)| 封装核心 更易于使用 |
|[@wechatferryxxx/puppet](https://github.com/wechatferry/wechatferry/tree/main/packages/puppet)| 让 Wechaty 免费协议重放荣光 |
|[@wechatferryxxx/nuxt](https://github.com/wechatferry/wechatferry/tree/main/packages/nuxt)| 使 Nuxt 轻松接入微信机器人 |
|[@wechatferryxxx/plugins](https://github.com/wechatferry/wechatferry/tree/main/packages/plugins)| 随便实现的几个插件 |
